![Banner](https://github.com/ProjetosDesvAIAT/ProjetosDesvAIAT/blob/main/banner.png)
...
[![GitHub followers](https://img.shields.io/github/followers/ProjetosDesvAIAT?style=social)](https://github.com/ProjetosDesvAIAT)
[![GitHub stars](https://img.shields.io/github/stars/ProjetosDesvAIAT?style=social)](https://github.com/ProjetosDesvAIAT)
...
### 🗺️ [AtlasQuest](https://github.com/ProjetosDesvAIAT/Aprimorando)
> Plataforma interativa de mapas colaborativos com POIs, progresso de usuário e inteligência artificial

- 🏗️ **Arquitetura de Microserviços** (NestJS + FastAPI + Next.js)
- 📍 **Sistema Geoespacial** com PostGIS e MapLibre GL
- 🤖 **Features de IA**: Deduplicação, auto-tagging, otimização de rotas
- ⚡ **Alta Performance**: Cache Redis, clustering server-side, p95 < 95ms
- 🔒 **Segurança**: JWT, RBAC, rate limiting
- 🐳 **Docker Compose** com setup automatizado

**Stack**: TypeScript, Next.js, NestJS, FastAPI, PostgreSQL, PostGIS, Redis, Docker
...
- 🔍 **Filtros avançados** por data, unidade e coordenador
- 💾 **API RESTful** com Express e MySQL

**Stack**: JavaScript, Node.js, Express, MySQL, HTML/CSS
...
- ✅ **Arquitetura de Microserviços** - Design e implementação de sistemas escaláveis
...
[![GitHub](https://img.shields.io/badge/GitHub-ProjetosDesvAIAT-181717?style=for-the-badge&logo=github)](https://github.com/ProjetosDesvAIAT)
[![Email](https://img.shields.io/badge/Email-Contato-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:projetosdesvAIAT@github.com)
...
> "The best code is the code that solves real problems with simplicity and elegance." 
...
![Visitor Count](https://komarev.com/ghpvc/?username=ProjetosDesvAIAT&color=blueviolet&style=for-the-badge)
